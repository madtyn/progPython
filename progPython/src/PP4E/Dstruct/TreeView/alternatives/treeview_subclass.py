...
from tkinter import Tk, Frame, Scrollbar, Label, Canvas, Button, Toplevel
from tkinter import YES, BOTH, TOP, RIGHT, LEFT, BOTTOM, RAISED, NW, X, Y
...
if __name__ == '__main__':
    from PP3E.Dstruct.Classics import btree  # import btree
    ...
    from PP3E.Lang.Parser import parser2  # import parser2
