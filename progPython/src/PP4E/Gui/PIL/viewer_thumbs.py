...
import sys
import math
from tkinter import Tk, Frame, Toplevel, Label, Button
from tkinter import X, YES, BOTTOM, BOTH, LEFT
...
def viewer(imgDir, kind=Toplevel, cols=None):
    ...
    quitBut = Button(win, text='Quit', command=win.quit, bg='beige')  # pack first
