...
def join(fromdir, tofile):
    '''
    Joins chunks in order to put them together in one only file
    :param fromdir: the directory which contains the chunks
    :param tofile: the name for the final resulting file
    '''
...
if __name__ == '__main__':
    if len(sys.argv) == 2 and sys.argv[1] == '-help':
        ...
        absfrom, absto = [os.path.abspath(x) for x in [fromdir, tofile]]
